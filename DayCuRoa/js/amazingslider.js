      ...
      embedHTML5Video: function ($container, src, autoPlay) {
        $container.html(
          "<div class='amazingslider-video-container-" +
            ...
            (this.options.videohidecontrols ? "" : "controls ") +
            " ></div>"
        );
            ...
            if (instance.options.navthumbstyle != "textonly") {
              ...
              $bullet.append(
                "<div class='amazingslider-bullet-image-" +
                  ...
                  "px;height:" +
                  instance.options.navimageheight +
                  "px;overflow:hidden;'><img class='amazingslider-bullet-img-" +
                  instance.id +
                  "' src='" +
      ...
      showImage: function (slideDirection, transEffect) {
        ...
        $(imgLoader).load(function () {
          ...
          var imgCurCodes =
            ...
            "' style='display:block;position:absolute;left:0px;top:0px;width:100%;height:100%;overflow:hidden;'>";
          imgCurCodes +=
            "<img class='amazingslider-img-elem-" +
            instance.id +
            "' data-originalwidth='" +
            this.width +
            "' data-originalheight='" +
    ...
    this.each(function () {
      ...
      if (
        ...
        if ($(this).data("textformat") in AMAZINGSLIDER_TEXT_EFFECT_FORMATS)
          this.options = $.extend(
            {},
            AMAZINGSLIDER_TEXT_EFFECT_FORMATS[$(this).data("textformat")],
            this.options
          );
      if (
        $(this).data("skin") &&
      ...
      var defaultOptions = {
        ...
        wimagedefault: "",
        wposcss:
          "display:block !important;position:absolute;top:6px;left:6px;visibility:visible !important;z-index:999999 !important;",
        wtextcssdefault:
      ...
      if (
        this.options.playvideoimage.substring(0, 7).toLowerCase() !=
          "http://" &&
        this.options.playvideoimage.substring(0, 8).toLowerCase() != "https://"
      )
        this.options.playvideoimage =
          this.options.skinsfolder + this.options.playvideoimage;
      if (
        this.options.navthumbnavigationarrowimage
          .substring(0, 7)
          .toLowerCase() != "http://" &&
        this.options.navthumbnavigationarrowimage
          .substring(0, 8)
        ...
        this.options.navthumbnavigationarrowimage =
          this.options.skinsfolder + this.options.navthumbnavigationarrowimage;
      if (
        this.options.navplayvideoimage.substring(0, 7).toLowerCase() !=
          "http://" &&
        this.options.navplayvideoimage.substring(0, 8).toLowerCase() !=
          "https://"
      )
        this.options.navplayvideoimage =
          this.options.skinsfolder + this.options.navplayvideoimage;
      var sliderid;
