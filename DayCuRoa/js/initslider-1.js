jQuery(document).ready(function () {
  ...
  jQuery("#amazingslider-1").amazingslider({
    ...
    descriptioncss:
      'display:block; position:relative; font:12px "Lucida Sans Unicode","Lucida Grande",sans-serif,Arial; color:#fff; margin-top:8px;',
    ...
    titlecss:
      'display:block; position:relative; font:bold 14px "Lucida Sans Unicode","Lucida Grande",sans-serif,Arial; color:#fff;',
    ribbonimagey: 0,
    ribbonimagex: 0,
