(function (i, g, c, h, e, k, f) {
  ...
  var b = (i.$Jssor$ = new (function () {
    ...
    function Gb() {
      if (!L) {
        ...
        if (E.pointerEnabled || (a = E.msPointerEnabled))
          L.Vd = a ? "msTouchAction" : "touchAction";
      }
      return L;
    }
    function v(h) {
    ...
    j.uc = function (c, d) {
      ...
      if (c)
        if (b.wd(c)) a = { db: a };
        else if (b.wd(c.$Clip)) a.$Clip = { db: c.$Clip };
      a.db = a.db || d;
  ...
  i.$JssorSlideshowRunner$ = function (n, s, q, u, z) {
    ...
    if (b.Yb() || b.$IsBrowserOpera() || (z && b.$WebKitVersion() < 537))
      i = 16;
    m.call(f);
    l.call(f, -1e7, 1e7);
  };
  var j = (i.$JssorSlider$ = function (q, hc) {
    ...
    var hb = a.$PlayOrientation & 3,
      ...
      I = b.p(
        { $Class: p, $PlayInMode: 1, $PlayOutMode: 1, $HWA: a.$HWA },
    ...
    if (r) {
      if (a.$HWA)
        Mb = function (a, c, d) {
          b.rb(a, { $TranslateX: c, $TranslateY: d });
        };
      L = a.$AutoPlay;
      o.Ob = hc;
      lc();
      ...
      a.$ArrowKeyNavigation &&
        b.$AddEvent(g, "keydown", function (b) {
    ...
    f.Dc = function (E) {
      if (!u) {
        ...
        for (var f = 0; f < s; f++) {
          ...
          B[f] = k;
          a.$ActionMode & 1 &&
            b.$AddEvent(k, "click", b.$CreateCallback(h, t, f));
          a.$ActionMode & 2 &&
            b.$AddEvent(k, "mouseover", b.Ub(b.$CreateCallback(h, t, f), k));
          y[f] = b.bc(k);
        }
        u = e;
      }
  ...
  i.$JssorThumbnailNavigator$ = function (g, B) {
    ...
    function A(o, f) {
      ...
      a.$ActionMode & 2 &&
        b.$AddEvent(c, "mouseover", b.Ub(b.$CreateCallback(h, j, 1), c));
    }
    i.Gc = function (b, e, f) {
      var a = p;
      p = b;
  ...
  i.$JssorCaptionSlideo$ = function (v, k, u, E) {
    ...
    function z(t, u, g) {
      ...
      b.$Each(u, function (i) {
        ...
        var o = { $Easing: j, $OriginalWidth: g.R, $OriginalHeight: g.S },
      ...
      if (a && d) {
        ...
        if (a.ib < p) {
          ...
          k = new l(a.ib, q - j, { Ac: q - a.ib, Oe: e });
          k.O(d, e);
        }
        i && a.Oc.push(i);
        k && a.Sc.push(k);
