(fotoramaVersion = "4.6.4"),
  (function (a, b, c, d, e) {
    ...
    function k(a) {
      var b = {};
      return (
        Ib ? (b.transform = "translate3d(" + a + "px,0,0)") : (b.left = a), b
      );
    }
    function l(a) {
    ...
    function w() {
      for (
        ...
        c > b && "number" != typeof (a = b ? arguments[b]() : arguments[b]);
        b++
      );
      return a;
    }
    ...
    function A(a, b) {
      ...
      return (
        ...
        !!c && { id: c, type: d, s: a.search.replace(/^\?/, ""), p: y() }
      );
    }
    function B(a, b, c) {
      var e,
    ...
    function $(a) {
      return (
        (a = (a + "").split(/\s+/)), { x: q(a[0]) || bc, y: q(a[1]) || bc }
      );
    }
    function _(a, b) {
      var c = a.data(),
      ...
      void 0 !== b.overPos &&
        ...
        (f = function () {
          _(
            a,
            d.extend({}, b, { overPos: b.pos, time: Math.max(Qb, b.time / 2) })
          );
        }));
      ...
      return (
        Nb
          ...
          : (T(t, "touchstart", e),
            ...
            Eb.on("scroll", j),
            a.on("mousedown", e),
            Fb.on("mousemove", f).on("mouseup", h)),
    ...
    function da(a, b) {
      ...
      function f(d, e) {
        D.noSwipe ||
          ...
          D.noMove ||
            (a.css(k(n)),
            z || ((z = !0), e.touch || Nb || a.addClass(eb)),
            (b.onMove || g).call(B, d, { pos: n, edge: o })));
      }
      function i(e) {
        if (!D.noSwipe || !e.moved) {
          A || c(e.startEvent, !0),
            e.touch || Nb || a.removeClass(eb),
            (r = d.now());
          for (
            var f,
              i,
      ...
      var j,
        ...
        D = {};
      return (D = d.extend(
        ca(b.$wrap, d.extend({}, b, { onStart: e, onMove: f, onEnd: i })),
        D
      ));
    }
    function ea(a, b) {
    ...
    if (void 0 !== b.cancelFullScreen) vb.ok = !0;
      ...
      for (var xb = 0, yb = wb.length; yb > xb; xb++)
        if (
          ((vb.prefix = wb[xb]), void 0 !== b[vb.prefix + "CancelFullScreen"])
        ) {
          vb.ok = !0;
          break;
        }
    vb.ok &&
      ((vb.event = vb.prefix + "fullscreenchange"),
      (vb.is = function () {
        switch (this.prefix) {
          case "":
            return b.fullScreen;
    ...
    var zb,
      ...
      Bb = { top: "auto", left: "auto", className: "" };
    !(function (a, b) {
      zb = b();
    })(0, function () {
      function a(a, c) {
        ...
        h(k.prototype, {
          spin: function (b) {
            ...
            if (
              ...
              !(function a() {
                l++;
                for (var b = 0; b < f.lines; b++)
                  (k = Math.max(
                    1 - ((l + (f.lines - b) * r) % p) * q,
                    f.opacity
                  )),
                    e.opacity(h, b * f.direction + n, k, f);
    ...
    (jQuery.Fotorama = function (a, e) {
        ...
        d.each(yc, function (a, b) {
          if (!b.i) {
            ...
            if (c) {
              var d = {};
              (b.video = c),
                b.img || b.thumb ? (b.thumbsReady = !0) : (d = B(b, yc, id)),
                C(yc, { img: d.img, thumb: d.thumb }, b.i, id);
            }
          }
        });
      }
      ...
      function i(a) {
        ...
        a
          ? (Fb.on(d, function (a) {
              ...
              Cc && 27 === a.keyCode
                ? ((b = !0), mc(Cc, !0, !0))
                : (id.fullScreen || (e.keyboard && !id.index)) &&
                  (27 === a.keyCode
                    ? ((b = !0), id.cancelFullScreen())
                ...
                (b || c) && Y(a),
                c && id.show({ index: c, slow: a.altKey, user: !0 });
            }),
            id.index ||
              Fb.off(b).on(b, "textarea, input, select", function (a) {
        ...
        b !== j.f &&
          (b
            ...
            : (qd.detach(),
              od.detach(),
              pd.detach(),
              a.html(nd.urtext).removeClass(kd),
              ha(id)),
          i(b),
          (j.f = b));
      }
      function m() {
        (yc = id.data = yc || P(e.data) || D(a)),
          (zc = id.size = yc.length),
          !xc.ok && e.shuffle && O(yc),
          f(),
          (Jd = y(Jd)),
          zc && j(!0);
      }
      function o() {
        ...
        (Md.noMove = a || Sc),
          (Md.noSwipe = a || !e.swipe),
          !Wc && sd.toggleClass(Ba, !e.click && !Md.noMove && !Md.noSwipe),
      ...
      function u() {
        ...
        (id.options = e = R(e)),
          (Sc = "crossfade" === e.transition || "dissolve" === e.transition),
          (Mc = e.loop && (zc > 2 || (Sc && (!Wc || "slide" !== Wc)))),
          (Vc = +e.transitionduration || Qb),
          (Yc = "rtl" === e.direction),
          (Zc = d.extend({}, e.keyboard && dc, e.keyboard));
        var b = { add: [], remove: [] };
        zc > 1 || e.enableifsingleframe
          ? ((Nc = e.nav),
            (Pc = "top" === e.navposition),
            b.remove.push(Xa),
            wd.toggle(!!e.arrows))
          : ((Nc = !1), wd.hide()),
          Ra(),
          (Bc = new zb(
            d.extend(Ab, e.spinner, Bb, { direction: Yc ? -1 : 1 })
          )),
          Gb(),
          Hb(),
          e.autoplay && t(e.autoplay),
          (Tc = n(e.thumbwidth) || Ub),
          (Uc = n(e.thumbheight) || Ub),
          (Nd.ok = Pd.ok = e.trackpad && !Mb),
          o(),
          ec(e, [Ld]),
          (Oc = "thumbs" === Nc),
          Oc
            ? (lb(zc, "navThumb"),
              ...
              yd.addClass(La).removeClass(Ka))
            : "dots" === Nc
            ? (lb(zc, "navDot"),
              (Ac = Ad),
              (hd = Yb),
              yd.addClass(Ka).removeClass(La))
            : ((Nc = !1), yd.removeClass(La + " " + Ka)),
          Nc &&
            (Pc ? xd.insertBefore(rd) : xd.insertAfter(rd),
            (wb.nav = !1),
            wb(Ac, zd, "nav")),
          (Qc = e.allowfullscreen),
          Qc
            ? (Dd.prependTo(rd), (Rc = Kb && "native" === Qc))
            : (Dd.detach(), (Rc = !1)),
          a(Sc, oa),
          a(!Sc, pa),
          a(!e.captions, va),
          a(Yc, ta),
          a("always" !== e.arrows, wa),
          (Xc = e.shadows && !Mb),
          a(!Xc, ra),
          qd.addClass(b.add.join(" ")).removeClass(b.remove.join(" ")),
          (Kd = d.extend({}, e));
      }
      function x(a) {
      ...
      function $() {
        (Md.min = Mc ? -1 / 0 : -r(zc - 1, Ld.w, e.margin, Fc)),
          (Md.max = Mc ? 1 / 0 : -r(0, Ld.w, e.margin, Fc)),
          (Md.snap = Ld.w + e.margin);
      }
      function ba() {
        (Od.min = Math.min(0, Ld.nw - zd.width())),
          (Od.max = 0),
          zd.toggleClass(Ba, !(Od.noMove = Od.min === Od.max));
      }
      function ca(a, b, c) {
        if ("number" == typeof a) {
          a = new Array(a);
              ...
              (j.html && "stage" === b) || !y || y === w
                ? (!w || j.html || r
                    ? "stage" === b &&
                      ...
                      n("load"),
                      fa())
                    : (k.trigger("f:error").removeClass(ab).addClass(_a),
                      n("error")),
                  (m.state = "error"),
                  !(zc > 1 && yc[i] === j) ||
                    j.html ||
                    ...
                    j.video ||
                    r ||
                    ((j.deleted = !0), id.splice(i, 1)))
                : ((j[v] = w = y), Pa([i], b, c, f, g, !0));
          }
          function p() {
            (d.Fotorama.measures[w] = u.measures =
              ...
              fa(u.measures.width, u.measures.height, u.measures.ratio, i),
              t
                .off("load error")
                .addClass(fb + (r ? " " + gb : ""))
                .prependTo(k),
              ...
              setTimeout(function () {
                k
                  ...
                  "stage" === b
                    ? n("load")
                    : (j.thumbratio === $b ||
                        (!j.thumbratio && e.thumbratio === $b)) &&
                      ((j.thumbratio = u.measures.ratio), vc());
              }, 0);
          }
          function q() {
            var a = 10;
        ...
        W(a, sc),
          X(a, function () {
            setTimeout(function () {
              ...
              Rb({ time: Vc, guessIndex: d(this).data().eq, minMax: Od });
          });
      }
      function lb(a, b) {
            ...
            "stage" === b
              ? (e.html &&
                  d('<div class="' + kb + '"></div>')
                    ...
                    .appendTo(f),
                e.caption && d(N(ob, N(pb, e.caption))).appendTo(f),
                e.video && f.addClass(za).append(Fd.clone()),
                X(i, function () {
                  setTimeout(function () {
                    Q(rd);
                  }, 0),
                    pc({ index: h.eq, user: !0 });
                }),
                (td = td.add(f)))
              : "navDot" === b
              ? (eb(i), (Ad = Ad.add(f)))
              : "navThumb" === b &&
                ...
                (Bd = Bd.add(f)),
                e.video && h.$wrap.append(Fd.clone()));
          }
        });
      }
      function sb(a, b, c, d) {
        ...
        ca(a, "stage", function (a, b, c, f, g, h) {
          if (f) {
            ...
            (h.eq = i),
              ...
              F(f[0]) && (f.appendTo(sd), mc(c.$video)),
              sb(h.$img, Ld, j, k),
              sb(h.$full, Ld, j, k);
          }
        });
        ...
        if (!wb[c]) {
          ...
          b.append(
            a
              .filter(function () {
                for (
                  var a, b = d(this), c = b.data(), e = 0, f = yc.length;
                  f > e;
                  e++
                )
                  if (c.data === yc[e]) {
      ...
      function Ob(a) {
        var b = Dc[hd].data();
        _(Cd, { time: 1.2 * a, pos: b.l, width: b.w - 2 * e.thumbborderwidth });
      }
      function Rb(a) {
        ...
        if (b) {
          var c = Od.min !== Od.max,
            ...
            e =
              ...
              (a.keep && Rb.l
                ? Rb.l
                : h((a.coo || Ld.nw / 2) - Lb(b).c, d.min, d.max)),
      ...
      function gc() {
        clearTimeout(hc.t),
          (fd = 1),
          e.stopautoplayontouch ? id.stopAutoplay() : (cd = !0);
      }
      function hc() {
        fd &&
          (e.stopautoplayontouch || (ic(), jc()),
      ...
      function jc() {
        if ((clearTimeout(jc.t), G.stop(jc.w), !e.autoplay || cd))
          return void (id.autoplay && ((id.autoplay = !1), fc("stopautoplay")));
      ...
      function kc() {
        id.fullScreen &&
          ...
          Db.removeClass(ja),
          Cb.removeClass(ja),
          a.removeClass(Za).insertAfter(pd),
          (Ld = d.extend({}, ed)),
          mc(Cc, !0, !0),
          rc("x", !1),
          id.resize(),
      ...
      function lc(a, b) {
        Xc &&
          (a.removeClass(Ua + " " + Va),
          b && !Cc && a.addClass(b.replace(/^|\s/g, " " + Ta + "--")));
      }
      function mc(a, b, c) {
        b && (qd.removeClass(na), (Cc = !1), o()),
          a && a !== Cc && (a.remove(), fc("unloadvideo")),
          c && (ic(), jc());
      }
      function nc(a) {
        qd.toggleClass(qa, a);
      ...
      function pc(a) {
        clearTimeout(pc.t),
          e.clicktransition && e.clicktransition !== e.transition
            ? setTimeout(function () {
                var b = e.transition;
                id.setOptions({ transition: e.clicktransition }),
                  (Wc = b),
                  (pc.t = setTimeout(function () {
                    id.show(a);
                  }, 10));
              }, 0)
            : id.show(a);
      ...
      function qc(a, b) {
        ...
        d(c).hasClass(mb)
          ...
          ? nc()
          : e.click &&
            pc({ index: a.shiftKey || Z(xb(a._x)), slow: a.altKey, user: !0 });
      }
      function rc(a, b) {
        Md[a] = Od[a] = b;
      }
      ...
      function tc(a) {
        pc({ index: wd.index(this) ? ">" : "<", slow: a.altKey, user: !0 });
      }
      function uc(a) {
        X(a, function () {
          setTimeout(function () {
      ...
      function vc() {
        if ((m(), u(), !vc.i)) {
          ...
          var a = e.startindex;
          (a || (e.hash && c.hash)) &&
            (Lc = L(a || c.hash.replace(/^#/, ""), yc, 0 === id.index || a, a)),
        ...
        if (zc) {
          ...
          Cc && mc(Cc, !0),
            ...
            bc(Xb),
            (vc.ok = !0),
            id.show({ index: Jd, time: 0 }),
            id.resize();
        } else id.destroy();
      }
      function wc() {
        return !wc.f === Yc
          ? ((wc.f = Yc), (Jd = zc - 1 - Jd), id.reverse(), !0)
          : void 0;
      }
      function xc() {
      ...
      var yc,
        ...
        Td = [];
      (qd[Xb] = d(N(ya))),
        (qd[Zb] = d(N(Ma + " " + Oa + rb, N(ib)))),
        (qd[Yb] = d(N(Ma + " " + Na + rb, N(hb)))),
        (Qd[Xb] = []),
        (Qd[Zb] = []),
        (Qd[Yb] = []),
        (Rd[Xb] = {}),
        qd.addClass(Ib ? ma : la).toggleClass(qa, !e.controlsonstart),
        (nd.fotorama = this),
        (id.startAutoplay = function (a) {
          return id.autoplay
            ? this
            : ((cd = dd = !1), t(a || e.autoplay), jc(), this);
        }),
        ...
        (id.show = function (a) {
          ...
          "object" != typeof a ? ((b = a), (a = {})) : (b = a.index),
            (b =
              ">" === b
                ...
                ? zc - 1
                : b),
            (b = isNaN(b) ? L(b, yc, !0) : b),
            (b = void 0 === b ? Jd || 0 : b),
            (id.activeIndex = Jd = z(b)),
            (Ic = E(Jd)),
            (Jc = U(Jd)),
            (Kc = x(Jd + (Yc ? -1 : 1))),
            (Ec = [Jd, Ic, Jc]),
          ...
          var i = g === Dc && !a.user;
          mc(Cc, Dc.i !== yc[x(Fc)].i),
            lb(Ec, "stage"),
            tb(Mb ? [Gc] : [Gc, E(Gc), U(Gc)]),
            rc("go", !0),
            i || fc("show", { user: a.user, time: d }),
            (cd = !0);
          var j = (id.show.onEnd = function (b) {
            if (!j.ok) {
              if (
                ((j.ok = !0),
                b || cc(!0),
                i || fc("showend", { user: a.user }),
                !b && Wc && Wc !== e.transition)
              )
                return id.setOptions({ transition: Wc }), void (Wc = !1);
        ...
        (id.requestFullScreen = function () {
          return (
            Qc &&
              ...
              rc("x", !0),
              (ed = d.extend({}, Ld)),
              a.addClass(Za).appendTo(Db.addClass(ja)),
              Cb.addClass(ja),
              mc(Cc, !0, !0),
              (id.fullScreen = !0),
              Rc && vb.request(ld),
        ...
        (id.resize = function (a) {
          ...
          return (
            q(d) &&
              ...
              (d = Ld.W = Ld.w = qd.width()),
              (Ld.nw = (Nc && p(e.navwidth, d)) || d),
              e.glimpse && (Ld.w -= Math.round(2 * (p(e.glimpse, d) || 0))),
              sd.css({ width: Ld.w, marginLeft: (Ld.W - Ld.w) / 2 }),
              (f = p(f, i)),
              (f = f || (g && d / g)) &&
                ((d = Math.round(d)),
                (f = Ld.h =
                  Math.round(h(f, p(Ld.minheight, i), p(Ld.maxheight, i)))),
                rd.stop().animate({ width: d, height: f }, b, function () {
                  qd.removeClass(ua);
                }),
                cc(),
                Nc &&
                  (yd.stop().animate({ width: Ld.nw }, b),
                  Rb({ guessIndex: Jd, time: b, keep: !0 }),
                  Oc && wb.nav && Ob(b)),
                ($c = c || !0),
                xc())),
            (Sd = rd.offset().left),
        ...
        (id.playVideo = function () {
          ...
          return (
            "object" == typeof b &&
              a.videoReady &&
              (Rc && id.fullScreen && id.cancelFullScreen(),
              G(
                function () {
                  return !vb.is() || c !== Jd;
                },
        ...
        (Md = da(sd, {
          ...
          onEnd: function (a) {
            lc(rd);
            var b =
              ((Nb && !gd) || a.touch) && e.arrows && "always" !== e.arrows;
            ...
            if (a.moved)
              a.pos !== a.newPos
                ? ((cd = !0),
                  ...
                  ub(a.newPos),
                  Xc && lc(yd, K(a.newPos, Od.min, Od.max)))
                : b();
            else {
        ...
        (Nd = ea(rd, {
          shift: !0,
          onEnd: function (a, b) {
            gc(), hc(), id.show({ index: b, slow: a.altKey });
          },
        })),
        (Pd = ea(yd, {
          onEnd: function (a, b) {
            gc(), hc();
            var c = v(zd) + 0.25 * b;
            zd.css(k(h(c, Od.min, Od.max))),
              Xc && lc(yd, K(c, Od.min, Od.max)),
              (Pd.prevent = { "<": c >= Od.max, ">": c <= Od.min }),
              clearTimeout(Pd.t),
          ...
          function (a, b) {
            id[b] = function () {
              return (
                (yc = yc || []),
                "load" !== b
                  ? Array.prototype[b].apply(yc, arguments)
                  : arguments[0] &&
            ...
            : G(
                ...
                function () {
                  (f.urtext = e.html()),
                    new d.Fotorama(
                      e,
                      d.extend({}, cc, a.fotoramaDefaults, b, f)
                    );
                }
              );
        });
