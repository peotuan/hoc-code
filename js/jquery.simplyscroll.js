!(function (a, b, c) {
  ...
  (a.simplyScroll = function (c, e) {
    ...
    (this.o = a.extend({}, d, e || {})),
      ...
      (this.isRTL = this.isHorizontal && "rtl" == a("html").attr("dir")),
      (this.isForwards =
        !this.isAuto ||
        (this.isAuto &&
    ...
    if (
      ...
      this.isHorizontal
        ? (g.each(function () {
          ...
          (h = g.eq(0).outerWidth(!0) * g.length !== i))
        : (g.each(function () {
            i += a(this).outerHeight(!0);
          }),
          (h = g.eq(0).outerHeight(!0) * g.length !== i)),
        h &&
          ((this.$list = this.$list
            .wrap("<div></div>")
            .parent()
            .addClass("simply-scroll-list")),
          this.isHorizontal
            ? this.$list.children().css({ float: "left", width: i + "px" })
            : this.$list.children().css({ height: i + "px" }));
    }
    this.o.startOnLoad
      ? a(b).load(function () {
          f.init();
    ...
    (a.simplyScroll.fn = a.simplyScroll.prototype = {}),
    (a.simplyScroll.fn.extend = a.simplyScroll.extend = a.extend),
    a.simplyScroll.fn.extend({
      init: function () {
        function g() {
          return (
            !1 === f.paused
              ? ((f.paused = !0), f.funcMovePause())
              : ((f.paused = !1), f.funcMoveResume()),
            f.paused
          );
        }
        (this.$items = this.$list.children()),
          ...
          (this.$btnBack = a(".simply-scroll-back", this.$container)),
          (this.$btnForward = a(".simply-scroll-forward", this.$container)),
          this.isHorizontal
        ...
        if (this.isAuto && "loop" == this.o.autoMode)
          this.$list.css(this.dimension, this.posMax + this.itemMax * b + "px"),
            (this.posMax += this.clipMax - this.o.speed),
            this.isForwards
              ? (this.$items.slice(0, b).clone(!0).appendTo(this.$list),
                (this.resetPosition = 0))
              : (this.$items.slice(-b).clone(!0).prependTo(this.$list),
          ...
          (this.posMax += this.itemMax * b),
            this.$list.css(
              this.dimension,
              this.posMax + this.itemMax * b + "px"
            ),
            (this.posMax += this.clipMax - this.o.speed);
          this.$items.slice(0, b).clone(!0).appendTo(this.$list),
            this.$items.slice(-b).clone(!0).prependTo(this.$list);
          (this.resetPositionForwards = this.resetPosition = b * this.itemMax),
        ...
        if (
          ...
          (this.funcMoveBack = function (a) {
            a !== c && a.preventDefault(),
              (f.trigger = f.isAuto || "end" != f.o.manualMode ? null : this),
              f.isAuto
                ? f.isForwards
                  ? f.moveBack()
                  : f.moveForward()
          ...
          if (
            ...
            var h, i;
            this.$clip
              .bind(this.events.start, function (a) {
                g();
                var b = a.originalEvent.touches[0];
                (h = f.isHorizontal ? b.pageX : b.pageY),
                  (i = f.$clip[0]["scroll" + f.scrollPos]),
                  a.stopPropagation(),
                  a.preventDefault();
              })
              .bind(this.events.move, function (a) {
                ...
                var b = a.originalEvent.touches[0],
                  ...
                  d = h - c + i;
                d < 0 ? (d = 0) : d > f.posMax && (d = f.posMax),
                  (f.$clip[0]["scroll" + f.scrollPos] = d),
                  f.funcMovePause(),
                  (f.paused = !0);
              });
          } else
      ...
      moveForward: function () {
        ...
        (this.movement = "forward"),
          ...
          (a.interval = setInterval(function () {
            a.$clip[0]["scroll" + a.scrollPos] < a.posMax - a.clipMax
              ? (a.$clip[0]["scroll" + a.scrollPos] += a.o.speed)
              : a.isLoop
              ? a.resetPos()
      ...
      moveBack: function () {
        ...
        (this.movement = "back"),
          ...
          (a.interval = setInterval(function () {
            a.$clip[0]["scroll" + a.scrollPos] > a.posMin
              ? (a.$clip[0]["scroll" + a.scrollPos] -= a.o.speed)
              : a.isLoop
              ? a.resetPos()
              : a.moveStop(a.movement);
      ...
      moveStop: function (b) {
        this.movePause(),
          null !== this.trigger &&
            (void 0 !== b && a(this.trigger).addClass("disabled"),
            (this.trigger = null)),
          this.isAuto &&
            "bounce" == this.o.autoMode &&
            ("forward" == b ? this.moveBack() : this.moveForward());
      },
      moveResume: function () {
